...
const Connect = () => {
    return (
        <div>
            <section className="mx-auto max-w-screen-md bg-gray-400 px-4 rounded-br-3xl rounded-tl-3xl py-8">
                <div className="w-full shadow-2xl mb-2 rounded-l-md flex justify-center items-center">
                    ...
                    <div className="grid rounded-2xl bg-gray-500 p-4 lg:col-span-3 lg:p-12">
                        <span className="relative flex justify-center">
                            <div
                                className="absolute inset-x-0 top-1/2 h-px -translate-y-1/2 bg-transparent bg-gradient-to-r from-transparent via-gray-500 to-transparent opacity-75"
                            ></div>

                            <span className="relative z-10 bg-gray-500 px-6">Send me a message</span>
                        </span>
