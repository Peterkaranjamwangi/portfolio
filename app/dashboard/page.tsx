...
export default function DashboardHome() {
  return (
    <DashboardPage>
      <div className="h-full flex flex-col justify-center items-center space-y-8 px-4">
        {/* Main hero section */}
        <motion.div
        ...
        >
          ...
          <div className="font-mono text-sm space-y-2">
            ...
            <p className="text-gray-300 ml-4">name: &quot;{resumeData.summary.name}&quot;,</p>
            <p className="text-gray-300 ml-4">role: &quot;Full-Stack Developer&quot;,</p>
            <p className="text-gray-300 ml-4">location: &quot;{resumeData.summary.address}&quot;,</p>
        ...
        >
          {[
            ...
            { icon: Zap, label: '6+ Projects', sublabel: 'Completed' },
