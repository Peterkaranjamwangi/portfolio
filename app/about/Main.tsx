...
export default function Main() {
  return (
    <div className="bg-green-200 border-red-400 border-2 w-screen h-screen rounded ">
      <div className="bg-red-400 min-h-[600px] w-56 m-2 rounded-2xl border-white border-2 p-5">
        <div className="w-full h-full bg-black border-2 rounded-full border-purple-600"></div>
      </div>
    </div>
